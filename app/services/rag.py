...
def init_rag_components():
    ...
    answer_system_prompt = (
        ...
        "2. **BOOK ONLY.** Your ONLY source of truth is the provided book excerpts. NEVER invent, fabricate, or supplement with your own knowledge. If the excerpts contain a recipe, meal idea, or fact, present exactly what is in the excerpts and cite the page/section. If the excerpts do NOT contain what the user asks for (e.g. a specific recipe), say so honestly and offer to help find what the book does cover. Never present your own generated content as if it came from the book.\n"
